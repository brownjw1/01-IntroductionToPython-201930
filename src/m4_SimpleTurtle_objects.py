...
#
###############################################################################
natasha.pen=rg.Pen('green',15)
natasha.speed=7
natasha.left(30)
natasha.forward(70)
boris.speed=6
boris.pen=rg.Pen('yellow',20)
boris.right(50)
boris.forward(50)
###############################################################################
#
...
#
###############################################################################
xX_turtle_Guy_Xx = rg.SimpleTurtle('turtle')
xX_turtle_Guy_Xx.pen = rg.Pen('blue', 15)
xX_turtle_Guy_Xx.speed = 5
xX_turtle_Guy_Xx.forward(40)
xX_turtle_Guy_Xx.right(10)
xX_turtle_Guy_Xx.speed=2
xX_turtle_Guy_Xx.forward(70)
xX_turtle_Guy_Xx.left(90)
xX_turtle_Guy_Xx.forward(200)
###############################################################################
#
# DONE: 6.
